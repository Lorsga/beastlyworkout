const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AuthPage-BMf8tEJU.js","assets/firestore-CSdz_xXz.js","assets/ClientDashboardPage-CNQZUKS9.js","assets/AppShell-CV-BZHhJ.js","assets/CoachDashboardPage-D-pM7TG5.js","assets/OnboardingPage-Cdmhoyer.js"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ow="storage";function Uk(n=bc(),e){n=vt(n);const i=ml(n,Ow).getImmediate({identifier:e}),o=Of("storage");return o&&jk(i,...o),i}function jk(n,e,t,i={}){bk(n,e,t,i)}function Bk(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),i=n.getProvider("auth-internal"),o=n.getProvider("app-check-internal");return new Fk(t,i,o,e,Ss)}function zk(){Pi(new jr(Ow,Bk,"PUBLIC").setMultipleInstances(!0)),Rn(L_,M_,""),Rn(L_,M_,"esm2017")}zk();const $k={apiKey:"AIzaSyBMwuPSGuAL3BC4KbmKv7BXwumOvQH4q_U",authDomain:"beastlyworkout-e05ac.firebaseapp.com",projectId:"beastlyworkout-e05ac",storageBucket:"beastlyworkout-e05ac.firebasestorage.app",messagingSenderId:"450850141428",appId:"1:450850141428:web:3cdba0ebf48acfa9f51aa1"},rh=ov($k),Gn=LR(rh),dn=OP(rh);Uk(rh);const Vw=dk(rh,"us-central1");EA(Gn,Dv);const qk=kw(Vw,"bootstrapFirstAdmin"),Hk=kw(Vw,"setUserRole");async function oN(){const n=await qk();return await Wk(),n.data}async function aN(n,e){return(await Hk({uid:n,role:e})).data}async function Wk(){return Gn.currentUser?Gn.currentUser.getIdTokenResult(!0):null}async function Gk(n){const e=n??Gn.currentUser;if(!e)return null;const i=(await e.getIdTokenResult()).claims.role;return i==="admin"||i==="trainer"||i==="client"?i:null}function Ko(){return{createdAt:If(),updatedAt:If()}}function Kk(){return{updatedAt:If()}}function fn(){var e;const n=(e=Gn.currentUser)==null?void 0:e.uid;if(!n)throw new Error("unauthenticated");return n}async function Qk(n={}){const e=fn(),t=eh(dn,"users",e);return await Aw(t,{uid:e,...Ko(),...n},{merge:!0}),t}async function Xk(n){const e=n??fn();return HP(eh(dn,"users",e))}async function lN(n,e){const t=fn();await Aw(eh(dn,"users",t,"private",n),{...e,...Kk()},{merge:!0})}async function uN(n,e={}){const t=fn();return kl(gr(dn,"trainerClients"),{trainerId:t,clientId:n,...Ko(),...e})}async function cN(n){const e=fn(),t=Al(gr(dn,"trainerClients"),Rl("trainerId","==",e),Cl("createdAt","desc"));return Pl(t)}async function hN(n){const e=fn();return kl(gr(dn,"plans"),{trainerId:e,clientId:n.clientId,status:n.status,title:n.title,description:n.description??"",clientNotes:"",lastViewedAt:null,...Ko()})}async function dN(n,e){const t=fn(),i=n==="client"?"clientId":"trainerId",o=Al(gr(dn,"plans"),Rl(i,"==",t),Cl("createdAt","desc"));return Pl(o)}async function fN(n){const e=fn();return kl(gr(dn,"workoutLogs"),{trainerId:n.trainerId,clientId:e,sessionDate:n.sessionDate,notes:n.notes??"",durationMinutes:n.durationMinutes??null,trainerFeedback:"",...Ko()})}async function pN(n){const e=fn(),t=Al(gr(dn,"workoutLogs"),Rl("clientId","==",e),Cl("sessionDate","desc"));return Pl(t)}async function mN(n){const e=fn();return kl(gr(dn,"sessions"),{trainerId:e,clientId:n.clientId,startsAt:n.startsAt,endsAt:n.endsAt,type:n.type??"workout",notes:n.notes??"",...Ko()})}async function gN(n,e){const t=fn(),i=n==="client"?"clientId":"trainerId",o=Al(gr(dn,"sessions"),Rl(i,"==",t),Cl("startsAt","desc"));return Pl(o)}async function yN(n){const e=fn();return kl(gr(dn,"metrics"),{trainerId:n.trainerId,clientId:e,metricType:n.metricType,value:n.value,unit:n.unit,measuredAt:n.measuredAt,...Ko()})}async function _N(n){const e=fn(),t=Al(gr(dn,"metrics"),Rl("clientId","==",e),Cl("measuredAt","desc"));return Pl(t)}function xw(){const[n,e]=Z.useState(!0),[t,i]=Z.useState(Gn.currentUser),[o,l]=Z.useState(null);return Z.useEffect(()=>IA(Gn,async h=>{try{if(i(h),!h){l(null);return}await Pp(h);const f=await Gk(h);l(f)}catch{l(null)}finally{e(!1)}}),[]),Z.useMemo(()=>({initializing:n,user:t,role:o,isAuthenticated:!!t}),[n,t,o])}const Af=new Mr;Af.setCustomParameters({prompt:"select_account"});async function Pp(n){(await Xk(n.uid)).exists()||await Qk({email:n.email??"",displayName:n.displayName??"",role:"client"})}async function vN(){try{const n=await $A(Gn,Af);return await Pp(n.user),{redirected:!1,user:n.user}}catch(n){if(Jk(n))return await QA(Gn,Af),{redirected:!0,user:null};throw n}}async function EN(){const n=await JA(Gn);return n!=null&&n.user&&await Pp(n.user),n}async function wN(){return SA(Gn)}function Jk(n){if(!(typeof n=="object"&&n&&"code"in n))return!1;const e=String(n.code);return e==="auth/popup-blocked"||e==="auth/operation-not-supported-in-this-environment"}const Yk=Z.lazy(()=>Vc(()=>import("./AuthPage-BMf8tEJU.js"),__vite__mapDeps([0,1])).then(n=>({default:n.AuthPage}))),Zk=Z.lazy(()=>Vc(()=>import("./ClientDashboardPage-CNQZUKS9.js"),__vite__mapDeps([2,3,1])).then(n=>({default:n.ClientDashboardPage}))),eN=Z.lazy(()=>Vc(()=>import("./CoachDashboardPage-D-pM7TG5.js"),__vite__mapDeps([4,3,1])).then(n=>({default:n.CoachDashboardPage}))),tN=Z.lazy(()=>Vc(()=>import("./OnboardingPage-Cdmhoyer.js"),__vite__mapDeps([5,1])).then(n=>({default:n.OnboardingPage})));function kp(){return Me.jsx("main",{className:"page page-center",children:Me.jsxs("div",{className:"card",children:[Me.jsx("p",{className:"eyebrow",children:"Gym PT"}),Me.jsx("h1",{children:"Caricamento sessione"})]})})}function b_({allow:n,children:e}){const{user:t,role:i,initializing:o}=xw();return o?Me.jsx(kp,{}):t?i?n.includes(i)?e:Me.jsx(_s,{to:i==="client"?"/app/client":"/app/coach",replace:!0}):n.includes("client")?e:Me.jsx(_s,{to:"/auth",replace:!0}):Me.jsx(_s,{to:"/auth",replace:!0})}function nN(){const{user:n,role:e,initializing:t}=xw();return t?Me.jsx(kp,{}):n?e?Me.jsx(_s,{to:e==="client"?"/app/client":"/app/coach",replace:!0}):Me.jsx(_s,{to:"/app/client",replace:!0}):Me.jsx(_s,{to:"/auth",replace:!0})}function rN(){return Me.jsx(Z.Suspense,{fallback:Me.jsx(kp,{}),children:Me.jsxs(jT,{children:[Me.jsx(ps,{path:"/",element:Me.jsx(nN,{})}),Me.jsx(ps,{path:"/auth",element:Me.jsx(Yk,{})}),Me.jsx(ps,{path:"/onboarding",element:Me.jsx(tN,{})}),Me.jsx(ps,{path:"/app/coach",element:Me.jsx(b_,{allow:["admin","trainer"],children:Me.jsx(eN,{})})}),Me.jsx(ps,{path:"/app/client",element:Me.jsx(b_,{allow:["client"],children:Me.jsx(Zk,{})})}),Me.jsx(ps,{path:"*",element:Me.jsx(_s,{to:"/",replace:!0})})]})})}K0.createRoot(document.getElementById("root")).render(Me.jsx(U_.StrictMode,{children:Me.jsx(GT,{children:Me.jsx(rN,{})})}));export{iN as L,_s as N,W_ as a,oN as b,EN as c,Wk as d,vN as e,dN as f,Gk as g,gN as h,pN as i,Me as j,_N as k,wN as l,fN as m,yN as n,cN as o,uN as p,hN as q,Z as r,mN as s,aN as t,xw as u,Qk as v,lN as w};
