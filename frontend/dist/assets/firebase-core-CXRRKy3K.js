 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tt{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(nt(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function nt(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const L="@firebase/app",q="0.13.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hn=Ot;function xt(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:k,automaticDataCollectionEnabled:!0},e),r=s.name;if(typeof r!="string"||!r)throw g.create("bad-app-name",{appName:String(r)});if(n||(n=ie()),!n)throw g.create("no-options");const i=A.get(r);if(i){if(R(n,i.options)&&R(s,i.config))return i;throw g.create("duplicate-app",{appName:r})}const o=new Le(r);for(const l of F.values())o.addComponent(l);const c=new $t(n,s,o);return A.set(r,c),c}function un(t=k){const e=A.get(t);if(!e&&t===k&&ie())return xt();if(!e)throw g.create("no-app",{appName:t});return e}function I(t,e,n){var s;let r=(s=Tt[t])!==null&&s!==void 0?s:t;n&&(r+=`-${n}`);const i=r.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const c=[`Unable to register library "${r}" with version "${e}":`];i&&c.push(`library name "${r}" contains illegal characters (whitespace or "/")`),i&&o&&c.push("and"),o&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),f.warn(c.join(" "));return}j(new S(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zt(t){j(new S("platform-logger",e=>new tt(e),"PRIVATE")),j(new S("heartbeat",e=>new Ft(e),"PRIVATE")),I(L,q,t),I(L,q,"esm2017"),I("fire-js","")}zt("");var Wt="firebase",Gt="11.10.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */I(Wt,Gt,"app");export{S as C,ae as E,E as F,Ve as L,hn as S,j as _,tn as a,en as b,dn as c,cn as d,an as e,d as f,Zt as g,oe as h,qt as i,be as j,Ie as k,ln as l,Ce as m,un as n,R as o,Kt as p,on as q,I as r,nn as s,sn as t,Xt as u,Qt as v,Jt as w,Yt as x,rn as y,xt as z};
