 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Hg;function X0(){return Hg||(Hg=1,(function(n){function e(Z,pe){var se=Z.length;Z.push(pe);e:for(;0<se;){var x=se-1>>>1,W=Z[x];if(0<o(W,pe))Z[x]=pe,Z[se]=W,se=x;else break e}}function t(Z){return Z.length===0?null:Z[0]}function i(Z){if(Z.length===0)return null;var pe=Z[0],se=Z.pop();if(se!==pe){Z[0]=se;e:for(var x=0,W=Z.length,de=W>>>1;x<de;){var Ie=2*(x+1)-1,Ae=Z[Ie],Oe=Ie+1,be=Z[Oe];if(0>o(Ae,se))Oe<W&&0>o(be,Ae)?(Z[x]=be,Z[Oe]=se,x=Oe):(Z[x]=Ae,Z[Ie]=se,x=Ie);else if(Oe<W&&0>o(be,se))Z[x]=be,Z[Oe]=se,x=Oe;else break e}}return pe}function o(Z,pe){var se=Z.sortIndex-pe.sortIndex;return se!==0?se:Z.id-pe.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;n.unstable_now=function(){return l.now()}}else{var h=Date,f=h.now();n.unstable_now=function(){return h.now()-f}}var g=[],y=[],E=1,T=null,I=3,F=!1,z=!1,$=!1,b=typeof setTimeout=="function"?setTimeout:null,oe=typeof clearTimeout=="function"?clearTimeout:null,re=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function ee(Z){for(var pe=t(y);pe!==null;){if(pe.callback===null)i(y);else if(pe.startTime<=Z)i(y),pe.sortIndex=pe.expirationTime,e(g,pe);else break;pe=t(y)}}function ue(Z){if($=!1,ee(Z),!z)if(t(g)!==null)z=!0,Vt(Pe);else{var pe=t(y);pe!==null&&Be(ue,pe.startTime-Z)}}function Pe(Z,pe){z=!1,$&&($=!1,oe(A),A=-1),F=!0;var se=I;try{for(ee(pe),T=t(g);T!==null&&(!(T.expirationTime>pe)||Z&&!O());){var x=T.callback;if(typeof x=="function"){T.callback=null,I=T.priorityLevel;var W=x(T.expirationTime<=pe);pe=n.unstable_now(),typeof W=="function"?T.callback=W:T===t(g)&&i(g),ee(pe)}else i(g);T=t(g)}if(T!==null)var de=!0;else{var Ie=t(y);Ie!==null&&Be(ue,Ie.startTime-pe),de=!1}return de}finally{T=null,I=se,F=!1}}var Te=!1,D=null,A=-1,P=5,k=-1;function O(){return!(n.unstable_now()-k<P)}function V(){if(D!==null){var Z=n.unstable_now();k=Z;var pe=!0;try{pe=D(!0,Z)}finally{pe?R():(Te=!1,D=null)}}else Te=!1}var R;if(typeof re=="function")R=function(){re(V)};else if(typeof MessageChannel<"u"){var rt=new MessageChannel,xt=rt.port2;rt.port1.onmessage=V,R=function(){xt.postMessage(null)}}else R=function(){b(V,0)};function Vt(Z){D=Z,Te||(Te=!0,R())}function Be(Z,pe){A=b(function(){Z(n.unstable_now())},pe)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(Z){Z.callback=null},n.unstable_continueExecution=function(){z||F||(z=!0,Vt(Pe))},n.unstable_forceFrameRate=function(Z){0>Z||125<Z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):P=0<Z?Math.floor(1e3/Z):5},n.unstable_getCurrentPriorityLevel=function(){return I},n.unstable_getFirstCallbackNode=function(){return t(g)},n.unstable_next=function(Z){switch(I){case 1:case 2:case 3:var pe=3;break;default:pe=I}var se=I;I=pe;try{return Z()}finally{I=se}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(Z,pe){switch(Z){case 1:case 2:case 3:case 4:case 5:break;default:Z=3}var se=I;I=Z;try{return pe()}finally{I=se}},n.unstable_scheduleCallback=function(Z,pe,se){var x=n.unstable_now();switch(typeof se=="object"&&se!==null?(se=se.delay,se=typeof se=="number"&&0<se?x+se:x):se=x,Z){case 1:var W=-1;break;case 2:W=250;break;case 5:W=1073741823;break;case 4:W=1e4;break;default:W=5e3}return W=se+W,Z={id:E++,callback:pe,priorityLevel:Z,startTime:se,expirationTime:W,sortIndex:-1},se>x?(Z.sortIndex=se,e(y,Z),t(g)===null&&Z===t(y)&&($?(oe(A),A=-1):$=!0,Be(ue,se-x))):(Z.sortIndex=W,e(g,Z),z||F||(z=!0,Vt(Pe))),Z},n.unstable_shouldYield=O,n.unstable_wrapCallback=function(Z){var pe=I;return function(){var se=I;I=pe;try{return Z.apply(this,arguments)}finally{I=se}}}})(bd)),bd}var Wg;function J0(){return Wg||(Wg=1,Md.exports=X0()),Md.exports}/**
 * @license React
...
`)};function Vn(u){u.onreadystatechange&&u.onreadystatechange.call(u)}Object.defineProperty(es.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(u){this.m=u?"include":"same-origin"}});function Ar(u){let p="";return Te(u,function(_,w){p+=w,p+=":",p+=_,p+=`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jf{static newId(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=62*Math.floor(4.129032258064516);let i="";for(;i.length<20;){const o=XR(40);for(let l=0;l<o.length;++l)i.length<20&&o[l]<t&&(i+=e.charAt(o[l]%62))}return i}}function Se(n,e){return n<e?-1:n>e?1:0}function cf(n,e){let t=0;for(;t<n.length&&t<e.length;){const i=n.codePointAt(t),o=e.codePointAt(t);if(i!==o){if(i<128&&o<128)return Se(i,o);{const l=nE(),h=JR(l.encode(Fy(n,t)),l.encode(Fy(e,t)));return h!==0?h:Se(i,o)}}t+=i>65535?2:1}return Se(n.length,e.length)}function Fy(n,e){return n.codePointAt(e)>65535?n.substring(e,e+2):n.substring(e,e+1)}function JR(n,e){for(let t=0;t<n.length&&t<e.length;++t)if(n[t]!==e[t])return Se(n[t],e[t]);return Se(n.length,e.length)}function xo(n,e,t){return n.length===e.length&&n.every(((i,o)=>t(i,e[o])))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bw="storage";function Wk(n=Vc(),e){n=nt(n);const i=gl(n,bw).getImmediate({identifier:e}),o=Mf("storage");return o&&Gk(i,...o),i}function Gk(n,e,t,i={}){qk(n,e,t,i)}function Kk(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),i=n.getProvider("auth-internal"),o=n.getProvider("app-check-internal");return new Hk(t,i,o,e,Rs)}function Qk(){Ci(new jr(bw,Kk,"PUBLIC").setMultipleInstances(!0)),Rn(j_,B_,""),Rn(j_,B_,"esm2017")}Qk();const Xk={apiKey:"AIzaSyBMwuPSGuAL3BC4KbmKv7BXwumOvQH4q_U",authDomain:"beastlyworkout-e05ac.firebaseapp.com",projectId:"beastlyworkout-e05ac",storageBucket:"beastlyworkout-e05ac.firebasestorage.app",messagingSenderId:"450850141428",appId:"1:450850141428:web:3cdba0ebf48acfa9f51aa1"},sh=hv(Xk),Gn=zR(sh),pn=UC(sh);Wk(sh);const Fw=vk(sh,"us-central1");PA(Gn,Mv);Vw(Fw,"bootstrapFirstAdmin");const Jk=Vw(Fw,"setUserRole");async function hN(n,e){return(await Jk({uid:n,role:e})).data}async function dN(){return Gn.currentUser?Gn.currentUser.getIdTokenResult(!0):null}async function Yk(n){const e=n??Gn.currentUser;if(!e)return null;const i=(await e.getIdTokenResult()).claims.role;return i==="admin"||i==="trainer"||i==="client"?i:null}function oh(){return{createdAt:Pf(),updatedAt:Pf()}}function Uw(){return{updatedAt:Pf()}}function yr(){var e;const n=(e=Gn.currentUser)==null?void 0:e.uid;if(!n)throw new Error("unauthenticated");return n}async function Zk(n={}){const e=yr(),t=Ko(pn,"users",e);return await Dw(t,{uid:e,...oh(),...n},{merge:!0}),t}async function eN(n){const e=n??yr();return kw(Ko(pn,"users",e))}async function fN(n,e){const t=yr();await Dw(Ko(pn,"users",t,"private",n),{...e,...Uw()},{merge:!0})}async function pN(){return Rl(Bi(pn,"users"))}async function mN(n,e){return kw(Ko(pn,"users",n,"private",e))}async function gN(n){const e=yr();return Np(Bi(pn,"plans"),{trainerId:e,clientId:n.clientId,status:n.status,title:n.title,description:n.description??"",exercises:n.exercises,clientNotes:"",lastViewedAt:null,...oh()})}async function yN(n,e){const t=yr(),i=n==="client"?"clientId":"trainerId",o=nh(Bi(pn,"plans"),ih(i,"==",t));return Rl(o)}async function _N(n,e){await YC(Ko(pn,"plans",n),{...e,...Uw()})}async function vN(n){const e=yr();return Np(Bi(pn,"workoutLogs"),{trainerId:n.trainerId,clientId:e,sessionDate:n.sessionDate,notes:n.notes??"",durationMinutes:n.durationMinutes??null,trainerFeedback:"",...oh()})}async function EN(n){const e=yr(),t=nh(Bi(pn,"workoutLogs"),ih("clientId","==",e),kp("sessionDate","desc"));return Rl(t)}async function wN(n,e){const t=yr(),o=nh(Bi(pn,"sessions"),ih("clientId","==",t),kp("startsAt","desc"));return Rl(o)}async function TN(n){const e=yr();return Np(Bi(pn,"metrics"),{trainerId:n.trainerId,clientId:e,metricType:n.metricType,value:n.value,unit:n.unit,measuredAt:n.measuredAt,...oh()})}async function IN(n){const e=yr(),t=nh(Bi(pn,"metrics"),ih("clientId","==",e),kp("measuredAt","desc"));return Rl(t)}function jw(){const[n,e]=Y.useState(!0),[t,i]=Y.useState(Gn.currentUser),[o,l]=Y.useState(null);return Y.useEffect(()=>NA(Gn,async h=>{try{if(i(h),!h){l(null);return}await xp(h);const f=await Yk(h);l(f)}catch{l(null)}finally{e(!1)}}),[]),Y.useMemo(()=>({initializing:n,user:t,role:o,isAuthenticated:!!t}),[n,t,o])}const kf=new Mr;kf.setCustomParameters({prompt:"select_account"});async function xp(n){(await eN(n.uid)).exists()||await Zk({email:n.email??"",displayName:n.displayName??"",role:"client"})}async function SN(){try{const n=await XA(Gn,kf);return await xp(n.user),{redirected:!1,user:n.user}}catch(n){if(tN(n))return await nR(Gn,kf),{redirected:!0,user:null};throw n}}async function AN(){const n=await iR(Gn);return n!=null&&n.user&&await xp(n.user),n}async function RN(){return DA(Gn)}function tN(n){if(!(typeof n=="object"&&n&&"code"in n))return!1;const e=String(n.code);return e==="auth/popup-blocked"||e==="auth/operation-not-supported-in-this-environment"}const nN=Y.lazy(()=>Nc(()=>import("./AuthPage-DSVGFy6e.js"),__vite__mapDeps([0,1])).then(n=>({default:n.AuthPage}))),rN=Y.lazy(()=>Nc(()=>import("./ClientDashboardPage-VyRLlD5w.js"),__vite__mapDeps([2,3,1])).then(n=>({default:n.ClientDashboardPage}))),iN=Y.lazy(()=>Nc(()=>import("./CoachDashboardPage-CPzPvsGA.js"),__vite__mapDeps([4,3,1])).then(n=>({default:n.CoachDashboardPage}))),sN=Y.lazy(()=>Nc(()=>import("./OnboardingPage-B8IQAPCY.js"),__vite__mapDeps([5,1])).then(n=>({default:n.OnboardingPage})));function Vp(){return Ce.jsx("main",{className:"page page-center",children:Ce.jsxs("div",{className:"card",children:[Ce.jsx("p",{className:"eyebrow",children:"Gym PT"}),Ce.jsx("h1",{children:"Caricamento in corso"})]})})}function z_({allow:n,children:e}){const{user:t,role:i,initializing:o}=jw();return o?Ce.jsx(Vp,{}):t?i?n.includes(i)?e:Ce.jsx(Es,{to:i==="client"?"/app/client":"/app/coach",replace:!0}):n.includes("client")?e:Ce.jsx(Es,{to:"/auth",replace:!0}):Ce.jsx(Es,{to:"/auth",replace:!0})}function oN(){const{user:n,role:e,initializing:t}=jw();return t?Ce.jsx(Vp,{}):n?e?Ce.jsx(Es,{to:e==="client"?"/app/client":"/app/coach",replace:!0}):Ce.jsx(Es,{to:"/app/client",replace:!0}):Ce.jsx(Es,{to:"/auth",replace:!0})}function aN(){return Ce.jsx(Y.Suspense,{fallback:Ce.jsx(Vp,{}),children:Ce.jsxs(GT,{children:[Ce.jsx(gs,{path:"/",element:Ce.jsx(oN,{})}),Ce.jsx(gs,{path:"/auth",element:Ce.jsx(nN,{})}),Ce.jsx(gs,{path:"/onboarding",element:Ce.jsx(sN,{})}),Ce.jsx(gs,{path:"/app/coach",element:Ce.jsx(z_,{allow:["admin","trainer"],children:Ce.jsx(iN,{})})}),Ce.jsx(gs,{path:"/app/client",element:Ce.jsx(z_,{allow:["client"],children:Ce.jsx(rN,{})})}),Ce.jsx(gs,{path:"*",element:Ce.jsx(Es,{to:"/",replace:!0})})]})})}const Bw=Y.createContext(null);function lN({children:n}){const[e,t]=Y.useState([]),i=Y.useCallback((l,h)=>{const f=Date.now()+Math.floor(Math.random()*1e3);t(g=>[...g,{id:f,type:l,message:h}]),window.setTimeout(()=>{t(g=>g.filter(y=>y.id!==f))},3200)},[]),o=Y.useMemo(()=>({showSuccess:l=>i("success",l),showError:l=>i("error",l)}),[i]);return Ce.jsxs(Bw.Provider,{value:o,children:[n,Ce.jsx("div",{className:"toast-wrap","aria-live":"polite","aria-atomic":"true",children:e.map(l=>Ce.jsx("div",{className:`toast toast-${l.type}`,children:l.message},l.id))})]})}function PN(){const n=Y.useContext(Bw);if(!n)throw new Error("useToast must be used within ToastProvider");return n}tT.createRoot(document.getElementById("root")).render(Ce.jsx(q_.StrictMode,{children:Ce.jsx(lN,{children:Ce.jsx(eI,{children:Ce.jsx(aN,{})})})}));export{uN as L,Es as N,J_ as a,PN as b,AN as c,Zk as d,dN as e,SN as f,Yk as g,eN as h,yN as i,Ce as j,wN as k,RN as l,EN as m,IN as n,vN as o,TN as p,mN as q,Y as r,pN as s,_N as t,jw as u,gN as v,hN as w,fN as x};
