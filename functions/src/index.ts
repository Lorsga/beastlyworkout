  ...
  async (request) => {
    ...
    for (const [id, docSnap] of merged.entries()) {
      ...
      plans.push({
        ...
        warmup: typeof data.warmup === 'string' ? data.warmup : '',
        warmupVideoUrl: typeof data.warmupVideoUrl === 'string' ? data.warmupVideoUrl : '',
        warmupImageUrl: typeof data.warmupImageUrl === 'string' ? data.warmupImageUrl : '',
        warmupMediaUrl: typeof data.warmupMediaUrl === 'string' ? data.warmupMediaUrl : '',
